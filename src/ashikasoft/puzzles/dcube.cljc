...
(defn rtop-
  ...
  [cube]
  (into
    (mapv #(get cube %) (vector-of :int 5 3 0 6 1 7 4 2))
    (subvec cube 8)))
...
(defn rtop+
  ...
  [cube]
  (into
    (mapv #(get cube %) (vector-of :int 2 4 7 1 6 0 3 5))
    (subvec cube 8)))
...
(defn rbottom-
  ...
  (into
    (subvec cube 0 12)
    (mapv  #(get cube %) (vector-of :int 17 15 12 18 13 19 16 14))))
...
(defn rbottom+
  ...
  (into
    (subvec cube 0 12)
    (mapv #(get cube %) (vector-of :int 14 16 19 13 18 12 15 17))))
...
(defn rleft-
  ...
  [cube]
  (mapv #(get cube %) (vector-of :int 5 1 2 9 4 12 6 7 3 15 10 11 17 13 14 8 16 0 18 19)))
...
(defn rleft+
  ...
  [cube]
  (mapv #(get cube %) (vector-of :int 17 1 2 8 4 0 6 7 15 3 10 11 5 13 14 9 16 12 18 19)))
...
(defn rright-
  ...
  [cube]
  (mapv #(get cube %) (vector-of :int 0 1 7 3 10 5 6 14 8 9 16 4 12 13 19 15 11 17 18 2)))
...
(defn rright+
  ...
  [cube]
  (mapv #(get cube %) (vector-of :int 0 1 19 3 11 5 6 2 8 9 4 16 12 13 7 15 10 17 18 14)))
